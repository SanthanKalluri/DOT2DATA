...
:: Pass each name to mysqldump.exe and output an individual .sql file for each
  ...
  "C:\Program Files\MySQL\MySQL Workbench 6.3 CE\mysql.exe" --user=%dbuser% --password=%dbpass%  --host=%host%  MIZEDDB  < "D:\mysql_mahesh_scripts\471.sql" > "D:\mysql_mahesh_scripts\471.out"
